...
#BF 17/10/2018 : -nodetrend in 3dRSFC is removed
#BF: 28/10/2018 : bandpassing was introdfuced


#***********
#Files are outputed in ${subid}_NEW_LFF.csv line 134s
#***********
...
restpp=Erest_pp.nii.gz

#insert subs
subjlist="12002 12004 12005 12006 12007 12008 12009 12010 12011 12012 12013 12014 12015 12016 12017 12018 12021 12022 12023 12025 12026 12027 12028 12029 12030 12031 12032 12034 12036 12037 12038 12040 22001 22002 22005 22006 22007 22009 22012 22013 22015 22017 22019 22021 22022 22023 22025 22026 22027 22030 22031 22034 22035 22037 22038 22039 22040 22041 22043 22044 22045 22046 22047 22049 22050 32001 32002 32003 32004 32005 32007 32008 32009 32010 32012 32013 32014 32015 32016 32017 32018 32020 32021 32022 32023 32024 32025 32026 32027 32028 32029 32030 32031 32032 32034 32035 32036 32037 32038 42001 42002 42003 42004 42005 42006 42007 42008 42009 42011 42013 42014 42015 42016 42017 42020 42021 42022 42024 42025 42026 42027 42028 42029 42030 42031 42032 42033 42034 42035 42036 42037 42039 42040" 
...
if [ ! -d $parcelsout ]
	...
	echo "**+ Parcel's in this site exist. Listing parcels and continue +**"
	ls  $parcelsout
...
do
	...
	do
		...
		#Call AFNI
		3dRSFC -prefix TmP_Parcel_$i -mask TmP_Parcel_$i.nii.gz 0.01 0.1 $restppfname
	...
	cd ..
	pwd
	echo "**+ Removing LFF dir of $sub. ${sub}_LFF.csv should be in CSV dir"
	rm -Rf $LFFout
